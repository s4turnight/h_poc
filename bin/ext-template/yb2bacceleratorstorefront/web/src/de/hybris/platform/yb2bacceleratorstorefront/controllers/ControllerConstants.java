	...
	interface Views
	{
		...
		interface Pages
		{
			interface Account
			{
				...
				String RegisterResultPage = "pages/account/registerResultPage";
			}
		...
		interface Fragments
		{
			...
			String ProductQuoteRequestPopup = "fragments/ProductQuoteRequestPopup";
			String ProductQuoteRequestResult = "fragments/ProductQuoteRequestResult";
		}
	}
}
